...
func TestBullseye(t *testing.T) {
	...
	ctx := startTestSpan(baseCtx, t)
	testLinuxDistro(ctx, t, debLinuxTestConfigFor(debian.BullseyeDefaultTargetKey, debian.BullseyeConfig, withPackageOverride("golang", "golang-1.19"), withPackageOverride("rust", "cargo-web"), withPackageOverride("bazel", "bazel-bootstrap")))
}
